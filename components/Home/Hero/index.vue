    ...
    <div class="relative lg:overflow-hidden">
        ...
        <div
            :class="{
                ...
                'top-80 xl:top-96 -right-16 -rotate-[76deg]': activeSlideIndex % 2 == 0,
            }">
        </div>

        <div
            class="w-full max-w-3xl px-4 py-10 mx-auto home-hero-swiper-container relative before:absolute before:content-[''] before:w-88 before:h-72 before:bg-[url('/assets/img/home/squares.webp')] before:bg-no-repeat before:bg-contain before:right-1/2 before:translate-x-1/2 before:top-24 sm:before:w-96 sm:before:h-80 sm:before:top-28 lg:before:w-[38rem] lg:before:h-[28rem] lg:before:top-52 xl:before:w-[38rem] xl:before:h-100 xl:before:top-60 after:absolute after:content-[''] after:w-40 after:h-36 after:rounded-full after:bg-primary-400 after:top-16 after:right-1/2 after:translate-x-1/2 after:blur-3xl lg:after:blur-[4rem] sm:after:w-52 sm:after:h-44 lg:after:top-40 lg:after:w-72 lg:after:h-56 xl:after:w-88 xl:after:h-68 xl:after:top-40 xl:after:blur-4xl">
        ...
        <div
            :class="{
                ...
                'top-64 xl:top-80 rotate-[14deg]': activeSlideIndex % 2 == 1,
            }">
        </div>
    </div>
</template>
