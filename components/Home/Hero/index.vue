    ...
    <div class="relative lg:overflow-hidden">
        ...
        <div
            ...
            <div class="flex flex-col mt-8 sm:mt-10 gap-4 sm:flex-row sm:justify-center z-1 relative lg:gap-6 lg:mt-12 xl:gap-8">
                <div class="relative before:absolute before:content-[''] before:h-12 before:w-56 before:rounded-full before:bg-secondary-500 before:-top-1 before:right-1/2 before:translate-x-1/2 before:blur-4xl md:before:w-28 md:before:h-14 md:before:-top-2 md:before:blur-3xl">
                    <button type="button" role="button" class="c-btn btn-danger-fill btn-md w-full sm:w-auto relative z-1">
                        <span> استعلام قیمت </span>
                    </button>
                </div>
                <button type="button" role="button" class="c-btn btn-secondary-fill btn-md w-full sm:w-auto relative z-1">
